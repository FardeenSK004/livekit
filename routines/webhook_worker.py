"""Background worker to reliably deliver webhooks offloaded by the agent via Redis."""
...
logger = logging.getLogger("routines.webhook_worker")


async def process_pending_webhooks():
    """Background worker loop to reliably deliver webhooks offloaded by the agent."""
