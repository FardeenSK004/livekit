...
echo " Webhook URL:  http://$LOCAL_IP:8082/api/v1/webhooks/telephony"
echo " SIP (Twilio): http://$LOCAL_IP:8082/api/v1/sip/trunks/outbound/twilio"
echo " SIP (Zadarma): http://$LOCAL_IP:8082/api/v1/sip/trunks/outbound/zadarma"
echo " SIP (Plivo):   http://$LOCAL_IP:8082/api/v1/sip/trunks/outbound/plivo"
echo " List Trunks:   GET http://$LOCAL_IP:8082/api/v1/sip/trunks/outbound"
echo " Delete Trunk:  DELETE http://$LOCAL_IP:8082/api/v1/sip/trunks/outbound/{trunk_id}"
echo " MCP Server:    MCP protocol on stdio"
echo " Inbound Trunk CRUD: http://$LOCAL_IP:8082/api/v1/sip/trunks/inbound"
echo " Dispatch Rule CRUD: http://$LOCAL_IP:8082/api/v1/sip/dispatch-rules"
echo "----------------------------------------------------------------"
